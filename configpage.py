...
class ConfigPage:
    ...
    def __init__(self):
        self.active = False
        self.made_with_pgui_surf = get_font("./assets/fonts/poppins-regular.ttf",12).render("Config page made with pygame_gui library", True, (255, 255, 255))
        ...
        self.s_resolution = pgui.elements.UIDropDownMenu(
            [str(Config.rSCREEN_WIDTH)+"x"+str(Config.rSCREEN_HEIGHT),"800x600", "1024x768", "1280x720", "1920x1080"],
        ...
        self.s_resolution_label = pgui.elements.UILabel(
            ...
            text="Resolution (Better restart):",
            manager=self.ui_manager
        )
